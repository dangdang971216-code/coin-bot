...
REGIME_RECOVERY_ENTRY_SIDEWAYS_EXTRA_STRENGTH = 0
...
WATCH_MIN_RECOVERY_FROM_LOW_PCT = 0.35
WATCH_MIN_RANGE_PCT = 0.18
WATCH_HIGH_VOL_MIN = 5.50
WATCH_HIGH_VOL_MIN_MOVE_PCT = 0.18
RECOVERY_ENTRY_MIN_30M_PCT = 0.35
RECOVERY_ENTRY_MIN_FROM_LOW_PCT = 0.60
RECOVERY_ENTRY_MIN_VOL_RATIO = 2.20
RECOVERY_ENTRY_MIN_LEADER_SCORE = 1.10
RECOVERY_ENTRY_MIN_HIGH_GAP_PCT = 0.85
RECOVERY_ENTRY_MIN_5M_PCT = 0.03
...
def status_command(update, context: CallbackContext):
    ...
    paused, pause_msg = should_pause_auto_buy_now()
    if paused:
        parts.append(f"⏸ 자동 쉬기: {pause_msg}")
