...
VERSION = "guard_v2.5.40_full_worker_systemd_manager_2026-05-21"
...
WORKER_SPECS = {
    ...
    "candle": {"label": "캔들", "prefix": "candle_worker", "active": "candle_worker.py", "service": "tradingbot-candle-worker", "status": "clean_candle_status.json", "log": "clean_candle_worker_service.log", "fresh_limit": 90},
    ...
    "risk": {"label": "위험", "prefix": "risk_worker", "active": "risk_worker.py", "service": "tradingbot-risk-worker", "status": "clean_risk_status.json", "log": "clean_risk_worker_service.log", "fresh_limit": 180},
    "strategy": {"label": "전략판정", "prefix": "strategy_worker", "active": "strategy_worker.py", "service": "tradingbot-strategy-worker", "status": "clean_strategy_worker_status.json", "log": "clean_strategy_worker_service.log"},
...
def gworker_state_text(name: Optional[str] = None) -> str:
    ...
    lines += ["", "[명령]", "- /gworker_upgrade : worker 8개 최신 적용", "- /gworker_restart : worker 8개 재시작", "- /gscanner_state /gcandle_state /gmarket_state /gfeature_state /gorderflow_state /grisk_state /gstrategy_state /greview_state"]
    return "\n".join(lines)
...
def wait_worker_ready(name: str, target_version: str = "", timeout: float = 18.0) -> tuple[dict, list[str]]:
    ...
    while time.time() - t0 < timeout:
        ...
        if last.get("service_active") == "active" and last.get("state") == "running" and last.get("age", 9999) < 20:
