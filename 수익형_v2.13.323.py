...
def health_text()->str:
    ...
    lines=[
        "🧭 건강상태 /health",
        f"✅ 메인봇 {BOT_VERSION} / clean worker hub v323 / uptime {int(now_ts()-START_TS)}s",
