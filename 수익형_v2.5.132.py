...
def send_startup_message():
    lines = [
        ...
        "",
        "이번 핵심 변경",
        "- 회복 초입형 분류 보강: 회복질/저점체류/거래대금지속이 좋으면 내부 감시로 더 살리도록 조정",
        "- 차트 정교화 후속: 재돌파 점수 부호와 한줄판단/결론 정렬 보정",
        "- 상위봉 fallback 유지: 4시간봉 값이 비는 구간은 하위봉 재구성 우선 사용",
