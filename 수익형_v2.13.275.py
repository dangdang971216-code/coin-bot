...
STRATEGY_KEY = "material_factory_v275"
...
def score_text() -> str:  # type: ignore[override]
    ...
    lines = [
        ...
        "",
        "[1] 현재버전",
        _v274_perf_line("v275", current, width=8),
        "- v275는 신규 모의매매 OPEN을 닫고 외부전략 재료를 수집합니다.",
        "",
        "[2] 전략실험 재료 현황",
        *_v275_lab_lines(rows, 7),
        "",
...
try:
    ...
    STRATEGY_KEY = "material_factory_v275"
    STATE["phase_note"] = "v275: 외부 전략 4종 재료 추가. 신규 모의매매 OPEN 닫고 전략별 필요정보 수집."
    STATE["v274_new_paper_open"] = "paused"
except Exception:
    pass
