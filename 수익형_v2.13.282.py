...
def _v282_material_schema(item: Dict[str, Any], mat: Dict[str, Any], strategy_scores: Dict[str, Dict[str, Any]], strategies: List[str], market: Dict[str, Any]) -> Dict[str, Any]:
    ...
    item.update({
        ...
        "v282_material_schema": True,
        "candidate_mode": "material_observe",
        "strategy": "재료수집",
        "strategy_key": "material_factory_v282",
        "route": "material_factory_v282",
        "schema": "strategy_material_v282",
        ...
        "final_entry_label": "v282 재료공장: 전략층 삭제 후 단일 schema / 신규 모의매매 닫힘",
        "trade_ready_label": "신규 모의매매 중지",
        "trade_ready_reasons": ["v282 재료공장", "전략층 삭제", "신규 paper OPEN 닫음"],
...
def _v277_light_material_row(row: Dict[str, Any], market: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return _v282_material_schema(item, mat or {}, strategy_scores, strategies, market)
...
def _v274_write_material_files(strict: List[Dict[str, Any]], shadow: List[Dict[str, Any]], market: Dict[str, Any], rejects: Optional[Counter] = None) -> None:  # type: ignore[override]
    ...
    payload = {
        ...
        "note": "v282: 단일 재료 schema. 기본 명령은 snapshot cache만 읽음.",
    }
...
# ===============================
V282_VERSION_TAG = "v2.13.282_schema_surgery_cache_single_path"
...
try:
    ...
    STATE["phase_note"] = "v282: missing_info 원천 schema 단일화, 중복 명령/캐시 함수 삭제, 재료 저장 단일 공장 경로."
