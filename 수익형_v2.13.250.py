...
_v250_base_consume_row = consume_row
...
def score_text() -> str:  # type: ignore[override]
    try:
        ...
        missed = _v250_missed_rows(watch_rows, _v250_paper_latest_rows())
        lines = [
            "📊 모의매매 성과 /score",
            ...
            *_v250_strategy_score_summary_lines(),
            ...
            "[4/4] 놓친 후보 요약",
            f"- 탈락 후 +1.2 먼저 도달: {len(missed)}개",
            *_v248_missed_bucket_lines(watch_rows, _v250_paper_latest_rows()),
            "",
            "판독",
