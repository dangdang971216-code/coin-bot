...
VERSION = "bithumb_micro_sidecar_v0.2_safe_poll_orderbook_tradeflow_2026-05-15"
MAX_TICKERS = int(os.getenv("CLEAN_MICRO_MAX_TICKERS", "16"))
POLL_SEC = float(os.getenv("CLEAN_MICRO_POLL_SEC", "5.0"))
REQUEST_TIMEOUT = float(os.getenv("CLEAN_MICRO_REQUEST_TIMEOUT_SEC", "2.0"))
STALE_SEC = float(os.getenv("CLEAN_MICRO_STALE_SEC", "20"))
TARGET_RELOAD_SEC = float(os.getenv("CLEAN_MICRO_TARGET_RELOAD_SEC", "4.0"))
MAX_WORKERS = int(os.getenv("CLEAN_MICRO_WORKERS", "3"))
USER_AGENT = "coinbot-bithumb-micro-sidecar/0.1"
