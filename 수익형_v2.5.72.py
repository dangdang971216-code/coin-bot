...
def _rescue_internal_watch_items(items):
    ...
    for item in internal_sorted:
        ...
        if primary_reason == '실시간 급등 초입':
            rescue_ok = rescue_ok and change_5 >= 0.90 and change_3 >= 0.05 and vol_ratio >= 2.55 and leader >= 0.95 and below_high >= 1.70 and turnover_5m >= 26000000 and change_30 >= -0.30
            if drought_sec >= 7200:
                rescue_ok = rescue_ok and change_5 >= 0.76 and vol_ratio >= 2.25 and below_high >= 1.45 and turnover_5m >= 22000000
            if not good_market:
            ...
            rescue_ok = rescue_ok and change_5 >= 0.74 and change_3 >= 0.01 and vol_ratio >= 2.20 and leader >= 0.84 and below_high >= 1.55 and turnover_5m >= 22000000 and from_low <= 1.75
            if drought_sec >= 7200:
                rescue_ok = rescue_ok and change_5 >= 0.62 and vol_ratio >= 1.95 and below_high >= 1.35 and turnover_5m >= 20000000
