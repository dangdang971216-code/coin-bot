...
def export_candidates(strict: List[Dict[str, Any]], shadow: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    result = {
        ...
        "latest_final_observe": 0,
        "dup_skip_reason": {},
        "data_quality_note": "v214_latest_first_archive_deferred",
        "dup_skip": 0,
        "write_error": "",
        "last_ticker": "-",
        "factory_mode": "v214_latest_first_no_archive_on_scan",
        "archive_deferred": 0,
    ...
    try:
        ...
        log_error("v214_enqueue_execution_risk", exc)
    ...
    try:
        ...
        with _state_lock:
            STATE["factory_external_overlay"] = "v214_latest_before_export_once"
            STATE["factory_external_overlay_ts"] = now_ts()
    except Exception as exc:
        log_error("v214_factory_external_overlay", exc)
    ...
    def _refresh_latest_ttl(row: Dict[str, Any], lane: str) -> Dict[str, Any]:
        ...
        rr["factory_mode"] = "v214_latest_first"
        ...
        ctx["factory_mode"] = "v214_latest_first"
...
def command_batch(update, context) -> None:
    funcs = [
        ...
        ("deploy", lambda: "\n".join(["📦 배포 상태 /deploy", f"- 메인봇 실행버전: {BOT_VERSION}", "- 메인봇 대상: 수익형_v2.13.214.py", "- 페이퍼봇 대상: paper_bot_v0.39.py"])),
    ]
    start = now_ts()
