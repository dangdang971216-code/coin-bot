...
VERSION = "guard_v2.5.16_gupgrade_main_paper_only_2026-05-14"
...
def help_text() -> str:
    return (
        ...
        "운영법: GitHub에 수익형_v*.py, paper_bot_v*.py, DEPLOY_TARGETS.json을 올리고 /gupgrade. ws_sidecar는 필요할 때만 /gws_state, /gws_restart로 별도 관리\n"
