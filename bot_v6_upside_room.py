...
STRATEGY_GUIDE = {
    ...
    "저점 선점형": "저점 근처에서 막 돌기 시작하는 초입 후보",
    "신저가 후 회복 감시": "신저가 근처를 찍은 뒤 바로 회복하는 초기 후보",
}
...
def format_watch_alert_line(item: dict, order: int = 1, alert_type: str = "new", reason_text: str = "") -> str:
    ...
    lines = [
        ...
        f"- 등급: {format_tier_badge(item.get('trade_tier','B'))} / 시장주목도: {safe_float(item.get('leader_score',0)):.2f}",
    ]
