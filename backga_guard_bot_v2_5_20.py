...
VERSION = "guard_v2.5.20_ws_upgrade_wait_rollback_2026-05-15"
...
def help_text() -> str:
    return (
        ...
        "운영법: main/paper는 /gupgrade, ws_sidecar는 /gws_upgrade로 별도 적용. 상태만 볼 때는 /gws_state, 재시작만 필요하면 /gws_restart\n"
