...
ENTRY_CONTEXT_KEYS = [
    "score", "edge", "edge_score", "change_1", "change_3", "change_5", "change_15", "change_30",
    "vol_ratio", "turnover_5m", "turnover_24h", "money_flow", "from_30m_low_pct", "below_30m_high_pct",
    "rank_best", "current_close_pos_ratio", "current_upper_wick_pct", "rsi_14", "vwap_gap_pct", "ma5_gap_pct",
    "liquidity_grade", "slippage_risk", "tick_risk", "tick_pct_est", "chase_risk", "price_recheck_pct",
    "orderbook_spread_pct", "execution_risk_status", "execution_risk_flags", "auto_ready_level", "auto_ready_label",
    "trade_ready_label", "trade_ready_reasons", "data_age_sec", "freshness", "current_candle_code", "current_candle_label",
]
