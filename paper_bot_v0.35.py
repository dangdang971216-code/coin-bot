...
ENTRY_CONTEXT_KEYS = [
    ...
    "final_entry_action", "final_entry_label", "final_entry_reasons", "final_slow_hits", "final_stop_hits", "market_pressure", "market_context", "quality_risk_tags",
