...
def build_price_check_markup(entries):
    ...
    for idx, (item, alert_type, _reason_text) in enumerate(entries, start=1):
        ...
        rows.append([
            ...
            InlineKeyboardButton("5분", callback_data=f"pc:{ref_id}:5"),
            InlineKeyboardButton("15분", callback_data=f"pc:{ref_id}:15"),
            InlineKeyboardButton("30분", callback_data=f"pc:{ref_id}:30"),
        ])
