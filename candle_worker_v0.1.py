...
VERSION="candle_worker_v0.1"
INTERVAL_SEC=float(os.getenv("CANDLE_WORKER_INTERVAL_SEC","4.0")); BATCH=int(os.getenv("CANDLE_WORKER_BATCH","18")); HTTP_TIMEOUT=float(os.getenv("CANDLE_WORKER_TIMEOUT","2.5"))
